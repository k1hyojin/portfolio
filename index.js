  ...
  lists:
    [
      ...
      },
      {
        ...
        concept: "배너, FAQ, 회원관리, 상품등록, 사이즈 정보 등 다양한 기능을 수정하고 관리할 수 있도록 제작된 페이지 입니다.<br>모든 페이지는 Back-end와 함께 제작하였고 My-sql을 사용하여 데이터를 관리합니다.<br>< 아이디:master,비밀번호:admin2 >로 기능이 제한된 관리자 모드로 로그인하실 수 있습니다.",
      ...
      },
      {
        thimg: "./img/p8.jpg",
        title: "VoViepedia",
        subtitle: "영화 사전 및 영화 즐겨찾기 페이지",
        tools: "Vue.js , Axios , SaSS, Vue-router, Vuex, tmdb API",
        concept: "영화 API 를 이용해 인기작품부터 개봉할 영화를 출력, 영화 검색, 영화즐겨찾기 기능을 가진 웹페이지입니다.<br> localStorage를 통해 좋아하는 영화를 즐겨찾기 할 수 있으며 유튜브 api를 통해 예고편 관람도 가능합니다.<br> Vuex를 통해 상태관리 리팩토링을 진행중입니다.",
        links: "https://k1hyojin.github.io/voviepedia/"
      }
    ]
}
